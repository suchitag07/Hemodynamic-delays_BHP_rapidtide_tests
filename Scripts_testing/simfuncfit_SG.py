...
def onesimfuncfit(
    ...
    if fixdelay:
        ...
        if initiallag is not None:
            ...
            new_lagmin = initiallag - despeckle_thresh / 2.0 # -- added by SG 4/22
            new_lagmax = initiallag + despeckle_thresh / 2.0 # -- added by SG 4/22
            print("onesimfuncfit :","initiallag=", initiallag,"despeckle_thresh=", despeckle_thresh,"setrange.lagmin=", new_lagmin,"setrange.lagmax=", new_lagmax) # -- added by SG 4/22
        else:
...
def fitcorr(
    ...
    print("FITCORR ENTRY:","thefitter.lagmin=", thefitter.lagmin,"thefitter.lagmax=", thefitter.lagmax) # -- added by SG 4/22
    ...
    print("FITCORR EXIT:","thefitter.lagmin=", thefitter.lagmin,"thefitter.lagmax=", thefitter.lagmax) # -- added by SG 4/22
