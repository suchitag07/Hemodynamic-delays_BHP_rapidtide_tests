    ...
    if simplefit:
        ...
        if optiondict["despeckle_passes"] > 0:
            ...
            for despecklepass in range(optiondict["despeckle_passes"]):
                print(f"START despeckle pass {thepass}, subpass {despecklepass + 1}:","theFitter.lagmin=", theFitter.lagmin,"theFitter.lagmax=", theFitter.lagmax,"theFitter.lagmod=", theFitter.lagmod,"optiondict_lagmin=", optiondict["lagmin"],"optiondict_lagmax=", optiondict["lagmax"]) # -- added by SG 4/22
                ...
                if len(initlags) > 0:
                    ...
                    if (patches_added > 0 and numdespeckled > 0) or (
                        ...
                        print(f"BEFORE fitcorr despeckle pass {thepass}, subpass {despecklepass + 1}:","theFitter.lagmin=", theFitter.lagmin,"theFitter.lagmax=", theFitter.lagmax,"theFitter.lagmod=", theFitter.lagmod,"optiondict_lagmin=", optiondict["lagmin"],"optiondict_lagmax=", optiondict["lagmax"],"numdespeckled=", numdespeckled) # -- added by SG 4/22
                        ...
                        # Soft-patch SG -- Restore limits
                        global_lagmin = optiondict["lagmin"]
                        global_lagmax = optiondict["lagmax"]
                        theFitter.setrange(global_lagmin, global_lagmax)
                        
                        print(f"AFTER fitcorr despeckle pass {thepass}, subpass {despecklepass + 1}:","theFitter.lagmin=", theFitter.lagmin,"theFitter.lagmax=",theFitter.lagmax,"theFitter.lagmod=", theFitter.lagmod,"optiondict_lagmin=", optiondict["lagmin"],"optiondict_lagmax=", optiondict["lagmax"],"numdespeckled=", numdespeckled) # -- added by SG 4/22
